...
<div id="left_column" class="col-xs-12 column" style="width:22%;">
    ...
    <div id="special_block_right" class="block"><p class="title_block"><a
        ...
        <div class="block_content products-block">
            <ul>
                <li class="clearfix"><a class="products-block-image"
                                        href="images/7-printed-chiffon-dress.html">
...
<div id="tmhomepage-slider">
    <ul id="tmhomeslider">
        <li class="tmhomeslider-container" id="slide_1"><a
            ...
            <div class="tmhomeslider-description"><h2>Natural Medicines</h2>
        ...
        <li class="tmhomeslider-container" id="slide_2"><a
            ...
            <div class="tmhomeslider-description"><h2>Hospitalist Medicines</h2>
        ...
        <li class="tmhomeslider-container" id="slide_3"><a
            ...
            <div class="tmhomeslider-description"><h2>Laboratory Medicines</h2>

                <p>No Insuarance ? No Problem</p></div>
        </li>
    </ul>
</div>
...
<div class="customNavigation"><a class="btn prev feature_prev"><i
        class="icon-chevron-sign-left"></i></a> <a class="btn next feature_next"><i
    ...
    <div class="product-container" itemscope itemtype="http://schema.org/Product">
        <div class="left-block">
            <div class="product-image-container"><a class="product_img_link"
                                                    ...
                                                    itemprop="url"> <img
                    class="replace-2x img-responsive"
                    src="images/faded-short-sleeve-tshirts.jpg"
    ...
    <div class="product-container" itemscope itemtype="http://schema.org/Product">
        <div class="left-block">
            <div class="product-image-container"><a class="product_img_link"
                                                    ...
                                                    itemprop="url"> <img
                    class="replace-2x img-responsive"
                    src="images/printed-summer-dress.jpg"
...
<div id="right_column" class="column col-xs-12" style="width:22%;">
            ...
            <ul>
                ...
                <li>
                    <a href="http://prestashop-demos.org/PRS04/PRS040084/en/55-printer-inks"
                       title=""> Printer &amp; inks </a></li>
                <li class="last"><a
                        href="http://prestashop-demos.org/PRS04/PRS040084/en/56-pc-componenet"
                ...
                <li>
                    <a href="http://prestashop-demos.org/PRS04/PRS040084/en/26-raincoats"
                       title="Nunc gavida nisl utrices loborti molis temp tempor quam congue turpis sed psum blandit donec vitae laoreet vestibulum lobortis mattis sapien bero cursus congue urna mauris pretium in adipiscing tellus aliquam.">
                        Raincoats </a></li>
                <li class="last"><a
                        href="http://prestashop-demos.org/PRS04/PRS040084/en/27-shirts"
                        title="Nunc gavida nisl utrices loborti molis temp tempor quam congue turpis sed psum blandit donec vitae laoreet vestibulum lobortis mattis sapien bero cursus congue urna mauris pretium in adipiscing tellus aliquam.">
                    Shirts </a></li>
            </ul>
        </li>
            ...
            <ul>
                ...
                <li>
                    <a href="http://prestashop-demos.org/PRS04/PRS040084/en/34-shorts-capries"
                       title=""> Shorts &amp; Capries </a></li>
                <li class="last"><a
                        href="http://prestashop-demos.org/PRS04/PRS040084/en/35-night-wear"
                        title="Nunc gavida nisl utrices loborti molis temp tempor quam congue turpis sed psum blandit donec vitae laoreet vestibulum lobortis mattis sapien bero cursus congue urna mauris pretium in adipiscing tellus aliquam.">
                    Night Wear </a></li>
            </ul>
        </li>
        <li class="last"><a
                href="http://prestashop-demos.org/PRS04/PRS040084/en/57-clothing"
                title="Nunc gavida nisl utrices loborti molis temp tempor quam congue turpis sed psum blandit donec vitae laoreet vestibulum lobortis mattis sapien bero cursus congue urna mauris pretium in adipiscing tellus aliquam.">
            Clothing </a>
            <ul>
                <li>
                    <a href="http://prestashop-demos.org/PRS04/PRS040084/en/58-new-arrivals"
                       title=""> New Arrivals </a></li>
                <li>
                    <a href="http://prestashop-demos.org/PRS04/PRS040084/en/59-casual-party-wear"
                       title="Nunc gavida nisl utrices loborti molis temp tempor quam congue turpis sed psum blandit donec vitae laoreet vestibulum lobortis mattis sapien bero cursus congue urna mauris pretium in adipiscing tellus aliquam.">
                        Casual &amp; Party Wear </a></li>
                <li>
                    <a href="http://prestashop-demos.org/PRS04/PRS040084/en/60-formal-shirts"
                       title=""> Formal Shirts </a></li>
                <li class="last"><a
                        href="http://prestashop-demos.org/PRS04/PRS040084/en/61-winter-wear"
                        title="Nunc gavida nisl utrices loborti molis temp tempor quam congue turpis sed psum blandit donec vitae laoreet vestibulum lobortis mattis sapien bero cursus congue urna mauris pretium in adipiscing tellus aliquam.">
                    Winter Wear </a></li>
            </ul>
        </li>
